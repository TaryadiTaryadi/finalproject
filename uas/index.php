...
<body style="margin-top: 30px; background-color: #1E2022;">
    <div class="container" style="background-color: #798777; width: 100%; padding: 10px;">
        <br><br>
        <div class="head">
        ...
        <div class="main">
            ...
            <tr>
                ...
                <th style="color: #FFFFFF;">Toilet_id</th>
                ...
                <th style="color: #FFFFFF;">User_id</th>
