...
if (isset($_GET['submit']) && !empty($_GET['q'])) {
    $q = $_GET['q'];
    $sql_where = "WHERE keterangan LIKE '{$q}%'";
}
$title = 'Toilet';
...
<body style="margin-top: 30px; background-color: #1E212D;">
    <div class="container" class="container" style="background-color: #798777; width: 50%; padding: 30px;">
        <br><br>
        <div class="head">
